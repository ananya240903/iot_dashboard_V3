    ...
    useEffect(() => {
        if (!selectedDeviceType.includes("All")) {
            ...
            if (validTypes.length === 0) {
                ...
                setSelectedDeviceType(validTypes);
            }
        }
    }, [deviceTypes, selectedDeviceType]);

    const { chartData, connectionStats, calibrationStats, alertStats, zoneStats } = useMemo(() => {
        ...
        <div className="bg-white/90 backdrop-blur-2xl p-8 rounded-3xl shadow-sm border border-slate-200/60 mb-8 transition-all duration-500">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-6">
                <div className="flex items-center gap-4">
                    <div className="p-3.5 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-2xl shadow-md shadow-indigo-500/20">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-8 items-start">
                ...
                <div className="xl:col-span-6 flex flex-col h-full">
                    {/* Google Map View */}
                    <div className="flex flex-col flex-grow bg-white/40 rounded-[2rem] p-5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-200/80 backdrop-blur-xl hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-500 z-0 relative min-h-0">
                        <div className="flex items-center gap-3 mb-4">
                            <div className="p-2.5 bg-gradient-to-br from-blue-500/10 to-blue-600/10 rounded-xl shadow-inner border border-blue-500/20">
